...
2. Implement a 'accelerate' method that will increase the car's speed by 10, and log the new speed to the console;
...
const cybertruck = new EV('Cybertruck', 120, 23);
...
and 'chargeBatter' methods of theis class, and also update the 'brake' method in the Car class. They experiment with chaining!
